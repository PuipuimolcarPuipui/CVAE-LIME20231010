...
dataset_class_num = {'breastcancer':2,
                    ...
                    'boston':'numerous',
                    'MNIST':10}
target_model = ['NN', 'RF', 'SVM', 'CNN'][target] #, 'NN', 'SVM', 'DNN', 'GBM', 'XGB'
...
auto_encoder_latent_dims = [2,4,6,7,8,10,12,32]
...
#活性潜在変数か否かの分散ベクトルの閾値
var_threshold = 0.5
for auto_encoder_latent_dim in auto_encoder_latent_dims:
    def main(dataset,
            dataset_class_num,
            target_model,
        ...
        for i in test_range:
            ...
            significant_coeffs = exp.significant_coeffs
            # iAUC = None
            ...
            temp = pd.DataFrame([[dataset,
                                ...
                                Active_latent_dim,
                                significant_coeffs]],
                                columns=['dataset', 'weighting_fn', 'epoch_num', 'latent_size', 'num_samples','select_percent','instance_no','predict_label','label', 'r2', 'mse','element1','element3','process_time','target_model','local_output','L1','L2','Active_latent_dim','significant_coeffs'])
