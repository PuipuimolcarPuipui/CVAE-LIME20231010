...
class LimeBase(object):
    ...
    def explain_instance_with_data(self,
        ...
        neighborhood_data, weights, yss, Active_latent_dim = AE_load(X_test = data_row,
                                    ...
                                    epochs = self.auto_encoder_setting['epochs'],
                                    latent_dim = self.auto_encoder_setting['latent_dim'],
                                    dataset = self.auto_encoder_setting['dataset'],
                                    auto_encoder = self.auto_encoder_setting['auto_encoder'],
                                    num_samples = self.auto_encoder_setting['num_samples'],
                                    instance_no = self.auto_encoder_setting['instance_no'],
                                    auto_encoder_weighting = self.auto_encoder_setting['auto_encoder_weighting'],
