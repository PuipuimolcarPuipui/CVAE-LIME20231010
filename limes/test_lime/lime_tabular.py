...
class LimeTabularExplainer(object):
    ...
    def __init__(self,
        ...
        self.lime_setting = lime_setting
        ...
        self.base = lime_base.LimeBase(kernel_fn, verbose, random_state=self.random_state, lime_setting=lime_setting)
    ...
    def explain_instance(self,
        ...
        """
        # インスタンス番号を辞書に追加
        self.lime_setting['instance_no'] = instance_no
